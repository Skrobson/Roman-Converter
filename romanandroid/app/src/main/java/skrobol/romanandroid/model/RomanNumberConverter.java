package skrobol.romanandroid.model;
...
public class RomanNumberConverter {
     ...
     * @version 1.0
     */
    protected class RomanNumberValidator {
    ...
    public int convert(String romanNumber) throws RomanNumberFormatException{
        ...
        if(validNumber(number))
            ...
            throw new RomanNumberFormatException(number + " is invalid number format");
        }
        else
            throw new RomanNumberFormatException("null string");
    }  
